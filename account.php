...
$stmt = $conn->prepare("SELECT full_name, email, phone, address, city, zip_code, country, created_at FROM users WHERE id = ?");
...
<section class="py-5 mb-5" style="background: url('images/background-pattern.jpg'); background-size: cover; background-repeat: no-repeat;">
  <div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center">
      <h1 class="text-dark fw-bold display-5">My Account</h1>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card border-0 shadow-sm rounded-4">
            <div class="card-body text-center p-4">
              ...
              <button class="btn btn-outline-primary w-100 rounded-3 mb-2" data-bs-toggle="modal" data-bs-target="#editAccountModal">
                Manage Account
              </button>
              <button class="btn btn-outline-danger w-100 rounded-3" data-bs-toggle="modal" data-bs-target="#changePasswordModal">
                Change Password
              </button>
            </div>
          </div>
            ...
            <div class="card-body p-4 p-md-5">
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <p class="fw-semibold"><?php echo htmlspecialchars($user['full_name']); ?></p>
                </div>
                <div class="col-md-6">
                  <label class="text-muted">Email Address</label>
                  <p class="fw-semibold"><?php echo htmlspecialchars($user['email']); ?></p>
                </div>
              </div>
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <p class="fw-semibold"><?php echo htmlspecialchars($user['phone'] ?? 'Not set'); ?></p>
                </div>
                <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <p class="fw-semibold">
                  <?php 
                  $addr_display = array_filter([
                      $user['address'] ?? '',
                      ($user['city'] ?? '') . ' ' . ($user['zip_code'] ?? ''),
                      $user['country'] ?? ''
                  ]);
                  echo !empty($addr_display) ? implode('<br>', $addr_display) : 'Not set';
                  ?>
                </p>
                </div>
              </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header border-bottom-0">
        <h5 class="modal-title" id="editAccountModalLabel">Manage Account</h5>
