      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="category-carousel swiper">
            <div class="swiper-wrapper">
              <a href="search.php?category=Fruits%20%26%20Veges" class="nav-link category-item swiper-slide">
                <img src="images/icon-vegetables-broccoli.png" alt="Category Thumbnail">
                <h3 class="category-title">Fruits & Veges</h3>
              </a>
              <a href="search.php?category=Breads%20%26%20Sweets" class="nav-link category-item swiper-slide">
                <img src="images/icon-bread-baguette.png" alt="Category Thumbnail">
                <h3 class="category-title">Breads & Sweets</h3>
              </a>
              <a href="search.php?category=Dairy" class="nav-link category-item swiper-slide">
                <img src="images/icon-soft-drinks-bottle.png" alt="Category Thumbnail">
                <h3 class="category-title">Dairy Products</h3>
              </a>
              <a href="search.php?category=Juices" class="nav-link category-item swiper-slide">
                <img src="images/icon-wine-glass-bottle.png" alt="Category Thumbnail">
                <h3 class="category-title">Drinks</h3>
              </a>
              <a href="search.php?category=Non%20veg" class="nav-link category-item swiper-slide">
                <img src="images/icon-animal-products-drumsticks.png" alt="Category Thumbnail">
                <h3 class="category-title">Non veg</h3>
              </a>
              <a href="search.php?category=packages" class="nav-link category-item swiper-slide">
                <img src="images/icon-bread-herb-flour.png" alt="Category Thumbnail">
                <h3 class="category-title">packages</h3>
              </a>
                ...
                <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                  ...
                  <div class="col">
                    <div class="product-item">
                      ...
                      <figure>
                        <a href="index.html" title="Product Title">
                          <img src="images/single-whole-red-apple-white.jpg" class="tab-image">
                        </a>
                      </figure>
                      <h3>Apple</h3>
                      <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24"
                  ...
                  <div class="col">
                    <div class="product-item">
                      ...
                      <figure>
                        <a href="index.html" title="Product Title">
                          <img src="images/mango-still-life.jpg" class="tab-image">
                        </a>
                      </figure>
                      <h3>Mango</h3>
                      <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24"
                  ...
                  <div class="col">
                    <div class="product-item">
                      ...
                      <figure>
                        <a href="index.html" title="Product Title">
                          <img src="images/thumb-chikoo.jpg" class="tab-image">
                        </a>
                      </figure>
                      <h3>chikoo</h3>
                      <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24"
                  ...
                  <div class="col">
                    <div class="product-item">
                      ...
                      <figure>
                        <a href="index.html" title="Product Title">
                          <img src="images/curd.jpg" class="tab-image">
                        </a>
                      </figure>
                      <h3>Curd</h3>
                      <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24"
                  ...
                  <div class="col">
                    <div class="product-item">
                      ...
                      <figure>
                        <a href="index.html" title="Product Title">
                          <img src="images/post-thumb-1.jpg" class="tab-image">
                        </a>
                      </figure>
                      <h3>Fruits</h3>
                      <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24"
                  ...
                  <div class="col">
                    <div class="product-item">
                      ...
                      <figure>
                        <a href="index.html" title="Product Title">
                          <img src="images/post-thumb-2.jpg" class="tab-image">
                        </a>
                      </figure>
                      <h3>Cashew Butter</h3>
                      <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24"
                  ...
                  <div class="col">
                    <div class="product-item">
                      ...
                      <figure>
                        <a href="index.html" title="Product Title">
                          <img src="images/post-thumb-3.jpg" class="tab-image">
                        </a>
                      </figure>
                      <h3>broccoli</h3>
                      <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24"
            ...
            <div class="swiper-wrapper">
              ...
              <div class="product-item swiper-slide">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <a href="#" class="nav-link btn-add-to-cart"><iconify-icon icon="uil:shopping-cart"></iconify-icon></a>
                </div>
              </div>
            ...
            <div class="col-md-6 p-3 p-md-5">
              <?php if (isset($_GET['subscribe'])): ?>
                ...
                <?php elseif ($_GET['subscribe'] == 'exists'): ?>
                    <div class="alert alert-warning">Email already subscribed.</div>
                <?php elseif ($_GET['subscribe'] == 'error'): ?>
              ...
              <form action="actions/subscribe.php" method="POST">
                ...
                <div class="form-check form-check-inline mb-3">
                  <label class="form-check-label" for="subscribe">
                    <input class="form-check-input" type="checkbox" id="subscribe" value="1" name="subscribe" checked>
                    Subscribe to the newsletter</label>
                </div>
                <div class="d-grid gap-2">
                  <button type="submit" class="btn btn-dark btn-lg">Submit</button>
