      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="footer-menu">
            ...
            <form class="d-flex mt-3 gap-0" role="newsletter" action="actions/subscribe.php" method="POST">
              <input class="form-control rounded-start rounded-0 bg-light" type="email" name="email" placeholder="Email Address"
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content rounded-4 shadow">
        ...
        <div class="modal-body px-5 pb-5">
          <h2 class="fw-bold mb-2 text-center" id="loginModalLabel">Welcome Back</h2>
          <p class="text-muted text-center mb-4">Please enter your details to sign in.</p>
          ...
          <ul class="nav nav-pills nav-justified mb-4" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link rounded-pill" id="pills-register-tab" data-bs-toggle="pill" data-bs-target="#pills-register" type="button" role="tab" aria-controls="pills-register" aria-selected="false">Register</button>
            </li>
          </ul>
          ...
          <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade" id="pills-register" role="tabpanel" aria-labelledby="pills-register-tab">
              <form id="registerForm" action="actions/register.php" method="POST">
                <div class="form-floating mb-3">
                  <input type="text" class="form-control rounded-3" id="registerName" name="full_name" placeholder="Full Name" required>
  ...
  <div class="modal fade" id="forgotPasswordModal" tabindex="-1" aria-labelledby="forgotPasswordModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content rounded-4 shadow">
        ...
        <div class="modal-body px-5 pb-5">
          <h2 class="fw-bold mb-2 text-center" id="forgotPasswordModalLabel">Forgot Password</h2>
          <p class="text-muted text-center mb-4">Enter your email address and we'll send you a new password.</p>
          
          <form id="forgotPasswordForm" action="actions/forgot_password.php" method="POST">
            <div class="form-floating mb-3">
              <input type="email" class="form-control rounded-3" id="forgotEmail" name="email" placeholder="name@example.com" required>
              <label for="forgotEmail">Email address</label>
            </div>
            <button class="w-100 mb-2 btn btn-lg rounded-3 btn-primary" type="submit">Send New Password</button>
            <div class="text-center mt-3">
              <a href="#" class="text-decoration-none" data-bs-toggle="modal" data-bs-target="#loginModal">Back to Login</a>
            </div>
          </form>
        </div>
      </div>
  ...
  <script>
    // Check for subscribe query param
    const urlParamsSubscribe = new URLSearchParams(window.location.search);
    const subscribeStatus = urlParamsSubscribe.get('subscribe');
    if (subscribeStatus) {
      if (subscribeStatus === 'success') {
        alert('Thank you for subscribing!');
      } else if (subscribeStatus === 'exists') {
        alert('You are already subscribed.');
      } else if (subscribeStatus === 'empty') {
